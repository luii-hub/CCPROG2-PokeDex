...
RANA, Luis Miguel, DLSU ID# <number>
...
int main()
{
    ...
    printf("````````````     "RED"*************"RESET"     ````````````\n");
    printf("````````/   "RED"***********************"RESET"   &````````\n");
    printf("``````   "RED"****"YELLOW"Hello Pokemon Trainer!"RED"***"RESET"   ``````\n");
    printf("````/  "RED"*********************************"RESET"  #````\n");
    printf("```  "RED",***************,   ,***************"RESET"   ```\n");
    printf("``  "RED",************             ************,"RESET"  ``\n");
    ...
    printf("```  @@@@@@@@@@@@@@         @@@@@@@@@@@@@@  ```\n");
    printf("````  $@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@(  ````\n");
    printf("`````#  @@@@"CYAN"Welcome to the PokeDex!"RESET"@@@&  $`````\n");
    printf("```````&   @@@@@@@@@@@@@@@@@@@@@@@@@   &```````\n");
    printf("``````````$    @@@@@@@@@@@@@@@@@    &``````````\n");
    printf("```````````````                ,```````````````\n");
    printf("```````````````````````````````````````````````\n\n");
...
void modifyEntry(struct details entry[], int* storedEntries){
    ...
    char modify20[21], modify50[51]; // temp string variables for name, type, and description
        ...
        while(i <= *storedEntries)
        {
            if(modifyIndex == i)
            {
                ...
                else if(category == 2)
                {
                    do
                    {
                    printf(YELLOW"Note: Pokemon Type must not exceed more than 20 Characters!\n\n"RESET"New Pokemon Type: ");
                    scanf(" %[^\n]s", modify20);
                    printf("\n");
