        ...
        while(j < storedEntries){
            if(modifyIndex == j){
                if(category == 1){
                    ...
                    printf("Invalid Category! Returning to Manage Data Menu\n");
                }
                printf("Printed Inside If-ModifyIndex\n");
            }
            j++;
            printf("Printed Inside While Loop\n");
        }
        printf("Printed in Else\n");
    }
    printf("Printed Outside If-Else\n");
}
